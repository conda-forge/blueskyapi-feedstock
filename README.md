...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/blueskyapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15608&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/blueskyapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `blueskyapi` can be installed with:

```
conda install blueskyapi
```

It is possible to list all of the versions of `blueskyapi` available on your platform with:
